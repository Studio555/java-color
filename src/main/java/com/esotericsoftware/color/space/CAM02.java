...
public record CAM02 (
	...
	public Lab Lab (VC vc) {
		return XYZ(vc).Lab();
	}

	public LRGB LRGB (VC vc) {
		return XYZ(vc).LRGB();
	}

	public RGB RGB (VC vc) {
		return XYZ(vc).RGB();
	}
	...
	public record VC (
		...
		static public final VC sRGB = VC.with(Observer.Default.D65, 318.31f, 20, 2, false);
	}
}
