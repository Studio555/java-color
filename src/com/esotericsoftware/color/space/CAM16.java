...
public record CAM16 (
	...
	public record VC (
		...
		static public final VC sRGB = VC.with(Observer.Default.D65, 64, 20, 2, false);
		static public final VC HCT = VC.with(Observer.Default.D65, 200 / PI * Lab.LstarToYn(50), 50, 2, false);
	}
}
