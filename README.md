...
50+ color spaces are supported including RGB variants (HSV, HSL), CIE spaces (Lab, Luv, XYZ), modern perceptual spaces (Oklab, Oklch), color appearance models (CAM16, CAM02), video formats (YCbCr, YUV), professional spaces (ACES, ITP), and specialized spaces for computer vision and printing. See the full list in [com.esotericsoftware.color.space](src/com/esotericsoftware/color/space/).
...
The library provides multiple methods for CCT calculations:
...
| K range | Max error | Max error K |
|----------------------|-------|---------------------|
| 1,000 - 2,000 | 0.09698486 | 1,014.59644 |
| 2,000 - 7,000 | 0.10644531 | 5,353.7134 |
| 7,000 - 20,000 | 1.0742188 | 19,944.176 |
| 20,000 - 60,000 | 2.0195312 | 59,854.04 |
| 60,000 - 100,000 | 2.1953125 | 94,087.12 |
...
For comparison, an Ohno 2013 table of 1545 floats uses 2.3x the memory for worse accuracy:

| K range | Max error | Max error K |
|-----------------------|------------|----------------------|
| 1,000 - 2,000         | 0.30993652 | 1,994.0573           |
| 2,000 - 7,000         | 1.0048828  | 6,999.519            |
| 7,000 - 20,000        | 2.6875     | 19,585.98            |
| 20,000 - 60,000       | 3.5429688  | 40,448.492           |
| 60,000 - 100,000      | 3.1367188  | 60,654.875           |

These numbers are with 0 Duv.
...
The library includes CIE standard observers:
