...
public class AccessibilityTests {
	...
	public void testWCAG_AA () {
		...
		if (Math.abs(ratio1 - 4.5f) < 0.1f) assertTrue(WCAG_AA(fg1, bg1, false), "Should pass AA at exactly 4.5:1 for normal text");
		...
		if (Math.abs(ratio2 - 3.0f) < 0.1f) assertTrue(WCAG_AA(fg2, bg2, true), "Should pass AA at exactly 3:1 for large text");
